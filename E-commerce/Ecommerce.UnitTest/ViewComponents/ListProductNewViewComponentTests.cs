...
{
    public class ListProductNewViewComponentTests
    {
        private readonly Fixture _fixture;

        public ListProductNewViewComponentTests()
        {
        ...
        public async Task InvokeAsync_ReturnsViewWithProducts()
        {
            ...
            mockProductService.Setup(service => service.GetAll(It.Is<QueryObject>(q => q.IsLatest == true)))
